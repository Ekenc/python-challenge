...
pollData = os.path.join("desktop","python-challenge","PyPoll","resources","election_data.csv")
...
with open(pollData, newline="", encoding="utf-8") as csvfile:
  ...
  # Create new list from CSV column "C" to get a full list of candidates who received votes
    candilist = list()
    tally = list()
  ...
  # total number of votes each candidate won & the percentage of votes each candidate won
    votes = list()
    percentage = list()
